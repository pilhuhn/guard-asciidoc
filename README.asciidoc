...
To learn how to setup Guard to send changes directly to the browser, refer to the Asciidoctor tutorial https://github.com/asciidoctor/asciidoctor.org/blob/master/docs/editing-asciidoc-with-live-preview.adoc[Editing with Live Preview].
